...
const ASCIIWave = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="absolute inset-0 bg-gradient-to-b from-[#e5e5e5] to-[#f5f5f5] dark:from-[#111] dark:to-[#080808] font-mono text-[8px] sm:text-[10px] leading-tight overflow-hidden select-none"
      aria-hidden="true"
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#f5f5f5]/30 via-transparent to-[#f5f5f5]/30 dark:from-[#080808]/30 dark:to-[#080808]/30" />
      <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#f5f5f5]/70 dark:to-[#080808]/70" />
    </div>
  );
};
...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] dark:bg-[#080808] text-black dark:text-white font-sans selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
      ...
      <main>
        <section className="max-w-7xl mx-auto px-12 py-24 border-x border-black/5 dark:border-white/5 bg-black/[0.02] dark:bg-white/[0.02]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-4">
              <h3 className="font-mono text-[10px] uppercase tracking-[0.2em] text-black/40 dark:text-white/40 mb-6 font-bold flex items-center gap-2">
                <span className="w-4 h-[1px] bg-black/20 dark:bg-white/20"></span> IDENTITY_MODULE
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {posts.slice(0, 6).map((post, idx) => (
              ...
              >
                ...
                >
                  <div className="font-mono text-[10px] uppercase tracking-[0.1em] text-black/50 dark:text-white/50 mb-6 font-bold">
        ...
        <section className="max-w-7xl mx-auto px-12 py-24 border-t border-x border-black/10 dark:border-white/10 bg-black/[0.01] dark:bg-white/[0.01]">
          <h3 className="font-mono text-[10px] uppercase tracking-[0.3em] text-black/40 dark:text-white/40 mb-16 font-bold text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-1 px-1 bg-black/10 dark:bg-white/10 border border-black/10 dark:border-white/10">
            {[
              ...
              <div key={idx} className="bg-[#f5f5f5] dark:bg-[#080808] p-12 hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-colors group relative">
